...
const FAQ = [
  ...
  {
    q: "細かい設定はどこまでできますか？",
    a: "テナントごとに変えられます。会話の本文を手足に全文渡すか、先頭だけにするか、渡さないか。添付は本体か、名前と種類だけか、渡さないか。添付を渡すときに上長の承認を要るかも決められます。契約書やNDAなどは、そのまま渡さずSealithの暗号化転送に切り替える設定もできます。全部を一律に厳しくする必要はなく、チャンネルや分類ごとに決められます。許可・止め方・記録はStaffpass、ファイルの暗号化受け渡しはSealith、という役割分担です。",
  },
];
